...
class SST5Template(Template):
    verbalizer = {
        0: "terrible",       # very negative
        1: "bad",            # negative
        2: "okay",           # neutral
        3: "good",           # positive
        4: "fantastic"       # very positive
    }
...
class SNLITemplate(Template):
    # SNLI label: 0 = entailment, 1 = neutral, 2 = contradiction
...
class TRECTemplate(Template):
    ...
    def encode(self, sample):
        question = sample.data["text"]
        return f"Question: {question}\nWhat type of question is this? Description, Entity, Abbreviation, Human, Location, or Number?\n"
